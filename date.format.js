...
jQuery.extend({
     ...
     */
    f: function (d, s) {
        //if(typeof jQuery.fmtDate==='undefined'){
        //   console.info('%c请先引入tgdz','background: #222; color: #bada55');
        //    $('head').append('<script src="date.tgdz.js"></script>');
        //}
    ...
    _do: function () {
        if(typeof this._d!=='string'){
            return this.fmtDate(this.format,this._d);
        }
